        ...
        <main className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">
              Welcome to Pally Feud ("Pally Arena", "we", "our", or "us"). By accessing or using our prediction game platform, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our service.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">
              To use Pally Feud, you must create an account using one of our supported authentication methods (wallet, email, or social login via Privy). You agree to:
            </p>
            <ul className="list-disc pl-6 mb-4 text-foreground space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">
              All content on Pally Feud, including text, graphics, logos, icons, images, and software, is owned by or licensed to us and is protected by copyright and trademark laws. You may not reproduce, distribute, or create derivative works without our express written permission.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">
              These Terms of Service shall be governed by and construed in accordance with the laws of the jurisdiction in which Pally Feud operates, without regard to its conflict of law provisions.
            </p>
          </section>
