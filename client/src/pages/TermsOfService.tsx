      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <main className="prose prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">
              PALLY TRADERS IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED. WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, SECURE, OR ERROR-FREE. YOUR USE OF THE SERVICE IS AT YOUR OWN RISK.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-foreground mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, PALLY TRADERS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS OR REVENUES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, OR ANY LOSS OF DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES.
            </p>
          </section>
